...
const AcceptInvitation = () => {
  ...
  useEffect(() => {
    ...
    // You could add a verification step here to check if the token is valid
    // before showing the form to set up the account
  }, [userId, token]);
    ...
    try {
      const response = await apiRequest(
        ...
        "POST",
        {
          ...
          phone: data.phone,
          service_type: "RESIDENT" // Default value, adjust as needed
        }
      );
      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Set up your account to join the building management system
          </CardDescription>
        </CardHeader>
